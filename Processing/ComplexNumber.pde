...
/**
 * @author      Gabe Stengel <gabriel.stengel16@trinityschoolnyc.org>
 * @version     2.0                
 * @since       2013-11-19          
 */
public class ComplexNumber {
  ...
  public ComplexNumber divide(ComplexNumber c){
    ComplexNumber n = new ComplexNumber((this.a*c.getReal()+this.b*c.getImaginary())/(c.getReal()*c.getReal()+c.getImaginary()*c.getImaginary()) ,(this.b*c.getReal()-this.a*c.getImaginary())/(c.getReal()*c.getReal()+c.getImaginary()*c.getImaginary()) );
    return n;
  }
